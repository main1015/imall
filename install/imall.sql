...
CREATE TABLE `{pre}ad_manage` (
  ...
  `width` smallint(5) NOT NULL default '0' COMMENT '广告宽度',
  `height` smallint(5) NOT NULL default '0' COMMENT '广告高度',
...
--
-- 表的结构 `{pre}msg_template`
--

DROP TABLE IF EXISTS `{pre}msg_template`;
CREATE TABLE `{pre}msg_template` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
INSERT INTO {pre}oauth VALUES (NULL, '人人网', '', 'renren', '人人网开放平台', 1, 'plugins/oauth/images/renren.gif');
INSERT INTO {pre}oauth VALUES (NULL, 'QQ', '', 'qq', '腾讯开发平台', 1, 'plugins/oauth/images/qq.gif');
INSERT INTO {pre}oauth VALUES (NULL, '新浪', '', 'sina', '新浪微博的开发平台', 1, 'plugins/oauth/images/sina.gif');
INSERT INTO {pre}oauth VALUES (NULL, '淘宝', '', 'taobao', '淘宝的开放平台', 1, 'plugins/oauth/images/taobao.gif');
...
--
-- 表的结构 `{pre}regiment_user_relation`
--

DROP TABLE IF EXISTS `{pre}regiment_user_relation`;
CREATE TABLE `{pre}regiment_user_relation` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `user_id` int(11) unsigned  NOT NULL COMMENT '用户id',
  ...
  index (`user_id`),
  index (`regiment_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='团购与用户关系表';
...
--
-- 导出表中的数据 `{pre}ad_position`
--

INSERT INTO `{pre}ad_position` VALUES (1, '页面顶部通栏广告条', 0, 0, 1, 1);
INSERT INTO `{pre}ad_position` VALUES (5, '首页左上方748*299', 748, 299, 1, 1);
INSERT INTO `{pre}ad_position` VALUES (6, '首页中部通栏', 0, 0, 1, 1);
...
INSERT INTO `{pre}areas` (`area_id`, `parent_id`, `area_name`, `sort`) VALUES
(110000, 0, '北京市', 99),
(120000, 0, '天津市', 99),
(130000, 0, '河北省', 99),
(140000, 0, '山西省', 99),
...
INSERT INTO `{pre}right` VALUES (NULL, '[商品]商品CSV导入', 'goods@csvImport,goods@importCsvFile', 0);
...
INSERT INTO `{pre}right` VALUES (NULL, '[商品]模型添加修改', 'goods@search_spec,goods@model_update,goods@model_edit', 0);
...
INSERT INTO `{pre}right` VALUES (NULL, '[会员]会员列表', 'member@member_list', 0);
...
INSERT INTO `{pre}right` VALUES (NULL, '[会员]会员预付款操作', 'member@member_recharge', 0);
...
INSERT INTO `{pre}right` VALUES (NULL, '[会员]建议列表', 'comment@suggestion_list', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]建议详情', 'comment@suggestion_edit', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]建议回复', 'comment@suggestion_edit_act', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]建议删除', 'comment@suggestion_del', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]咨询列表', 'comment@refer_list', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]咨询详情', 'comment@refer_edit', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]咨询回复', 'comment@refer_reply', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]咨询删除', 'comment@refer_del', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]讨论列表', 'comment@discussion_list', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]讨论详情', 'comment@discussion_edit', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]讨论删除', 'comment@discussion_del', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]评价列表', 'comment@comment_list', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]评价详情', 'comment@comment_edit', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]评价删除', 'comment@comment_del', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]站内消息列表', 'comment@message_list', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]站内消息发送', 'comment@message_send', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]站内消息删除', 'comment@message_del', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]到货通知列表', 'message@notify_list,message@notify_filter', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]到货通知删除', 'message@notify_del', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]到货通知发送Email', 'message@notify_send', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]到货通知导出CSV', 'message@notify_export', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]消息模板展示', 'message@tpl_list', 0);
...
INSERT INTO `{pre}right` VALUES (NULL, '[会员]邮件订阅导出CSV', 'message@registry_export', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[会员]消息模板修改', 'message@tpl_edit,message@tpl_save', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[订单]订单列表', 'order@order_list', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[订单]订单添加', 'order@order_note,order@order_update,order@order_edit', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[订单]订单修改', 'order@gePay_fee,order@order_pri_num,order@order_pri_num_del,order@order_note,order@order_update,order@order_edit,order@order_message', 0);
...
INSERT INTO `{pre}right` VALUES (NULL, '[订单]订单打印', 'order@merge_template,order@pick_template,order@shop_template,order@print_template_update,order@print_template', 0);
...
INSERT INTO `{pre}right` VALUES (NULL, '[订单]快递单添加修改', 'order@expresswaybill_edit,order@expresswaybill_edit_act,order@expresswaybill_upload,order@expresswaybill_template', 0);
INSERT INTO `{pre}right` VALUES (NULL, '[订单]快递单删除', 'order@expresswaybill_del', 0);
...
INSERT INTO `{pre}payment` VALUES (0, '货到付款', 2, 'freight_collect', '货到付款', '/payments/logos/pay_freight_collect.jpg', 1, 99, NULL, 0.00, 1, NULL,3);
INSERT INTO `{pre}payment` VALUES (NULL, '预存款', 1, 'balance', '预存款是客户在您网站上的虚拟资金帐户。', '/payments/logos/pay_deposit.gif',0,99,NULL,0.00,1,NULL,3);
INSERT INTO `{pre}payment` VALUES (NULL, '网银在线', 1, 'chinabank', '网银在线是中国领先的电子支付解决方案提供商之一。 <a href="http://www.chinabank.com.cn/" target="_blank">立即申请</a>', '/payments/logos/pay_chinabank.gif',1, 99, NULL, 0.00, 1, NULL,1);
INSERT INTO `{pre}payment` VALUES (NULL, '腾讯财付通', 1, 'tenpay', '财付通是腾讯公司创办的中国领先的在线支付平台，致力于为互联网用户和企业提供安全、便捷、专业的在线支付服务。 <a href="https://www.tenpay.com/v2/" target="_blank">立即申请</a>','/payments/logos/pay_tenpay.gif', 1, 99, NULL, 0.00, 1, NULL,1);
INSERT INTO `{pre}payment` VALUES (NULL, '快钱', 1, 'bill99', '快钱是国内领先的独立第三方支付企业，旨在为各类企业及个人提供安全、便捷和保密的支付清算与账务服务。 <a href="https://www.99bill.com/" target="_blank">立即申请</a>', '/payments/logos/pay_99bill.gif', 1, 99, NULL, 0.00, 1, NULL,1);
INSERT INTO `{pre}payment` VALUES (NULL, '支付宝担保交易', 1, 'trade_alipay', '担保交易支付方式，淘宝买家最熟悉的付款方式：买家先将交易资金存入支付宝并通知卖家发货，买家确认收货后资金自动进入卖家支付宝账户，完成交易。 <a href="http://www.alipay.com/" target="_blank">立即申请</a>', '/payments/logos/pay_alipay.gif', 1, 99, NULL, 0.00, 1, NULL,1);
INSERT INTO `{pre}payment` VALUES (NULL, '支付宝即时到帐', 1, 'direct_alipay', '即时到帐支付方式，网上交易时，买家的交易资金直接打入卖家支付宝账户，快速回笼交易资金。 <a href="http://www.alipay.com/" target="_blank">立即申请</a>', '/payments/logos/pay_alipay.gif', 1, 99, NULL, 0.00, 1, NULL,1);
INSERT INTO `{pre}payment` VALUES (NULL, '支付宝双接口', 1, 'alipay', '担保+即使双接口支付方式，给于买家充足的自主选择权。 <a href="http://www.alipay.com/" target="_blank">立即申请</a>', '/payments/logos/pay_alipay.gif', 0, 99, NULL, 0.00, 1, NULL,1);
INSERT INTO `{pre}payment` VALUES (NULL, '贝宝', 1, 'paypal', '是全球最大的在线支付平台，同时也是目前全球贸易网上支付标准。<a href="https://www.paypal-biz.com/" target="_blank">立即申请</a>', '/payments/logos/pay_paypal.gif', 1, 99, NULL, 0.00, 1, NULL,1);
INSERT INTO `{pre}payment` VALUES (NULL, '微信扫一扫', 1, 'wechat', '微信扫一扫支付接口。<a href="https://www.swiftpass.cn" target="_blank">立即申请</a>', '/payments/logos/pay_wechat.gif', 1, 99, NULL, 0.00, 1, NULL,1);
INSERT INTO `{pre}payment` VALUES (NULL, '线下支付', 2, 'offline', '线下付款结算', '/payments/logos/pay_offline.gif', 1, 99, NULL, 0.00, 0, NULL,3);
INSERT INTO `{pre}payment` VALUES (NULL, '银信证', 1, 'cipay', '银信证支付','/payments/logos/pay_cipay.jpg',1,99,NULL,0.00,0,NULL,1);
